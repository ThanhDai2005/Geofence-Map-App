    ...
    <div className="flex min-h-screen">
      <aside className="flex w-64 shrink-0 flex-col border-r border-slate-800 bg-slate-950">
        <div className="border-b border-slate-800 px-4 py-4">
          <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Cổng quản trị</p>
          <p className="mt-1 font-semibold tracking-tight text-emerald-400">VNGo Admin</p>
        </div>
        ...
        <div className="border-t border-slate-800 p-3">
          ...
          <p className="mt-0.5 px-1 text-[10px] font-medium uppercase text-slate-600">{role}</p>
          <button
            type="button"
            onClick={() => {
              logout();
