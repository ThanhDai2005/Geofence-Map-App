...
const intelligenceAnalyticsRollupDailySchema = new mongoose.Schema({
    ...
    collection: 'uis_analytics_rollups_daily',
    timestamps: false
});

intelligenceAnalyticsRollupDailySchema.index(
    { bucket_start: 1, event_family: 1, source_system: 1, auth_state: 1 },
    { unique: true, name: 'uniq_bucket_dims_daily' }
);
intelligenceAnalyticsRollupDailySchema.index(
    { bucket_start: 1 },
    { name: 'ix_rollups_daily_bucket_start' }
);

module.exports = mongoose.model(
    'IntelligenceAnalyticsRollupDaily',
    intelligenceAnalyticsRollupDailySchema
);
